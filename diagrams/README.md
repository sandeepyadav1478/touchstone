...
### The settled renders — **both rebuilt for D-089…D-094, 2026-08-24**

| | `loop.png` | `sequence.png` |
|---|---|---|
| Frame | 6411 × 12413 — **79.6 MP** *(was 6550 × 10394, 68.1 MP)* — ⚠️ **the axis ratios are 0.979 and 1.194**, which straddle 1.0, so [ERASER-NOTES](ERASER-NOTES.md) finding 3 calls it a **layout change and nothing else**. Both exports ran at `imageQuality: 1`, so quality was held constant as well | 9182 × 11400 — **104.7 MP** *(was 8742 × 10006, 87.5 MP)* |
| On disk | 4.12 MB *(was 3.74 MB)* | 4.94 MB *(was 4.36 MB)* — the 2026-08-23 jump from 0.77 MB was **5.7×** and it was content, not quality: the DSL went from 13 lifelines to 19, and is 20 now |
| Padding, L / T / R / B — **background-difference bbox, the guard's own comparator** | 46 / 75 / 42 / **73** *(was 47 / 66 / 43 / 63)* | 27 / 27 / 23 / 23 — **identical across a rebuild that added a lifeline and 17.2 MP** *(was 27 / 27 / 23 / 23)* |
...
| Ink — pixels with `convert("L") < 200`, as a share of the frame | **1.41%** *(was 1.52%)* | **3.60%** *(was 3.40%)* |
